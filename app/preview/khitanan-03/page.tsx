        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="space-y-6 lg:col-span-1">
            <div className="rounded-lg border p-6">
              ...
              <div className="mt-6">
                <Button className="w-full bg-teal-600 hover:bg-teal-700">Gunakan Template Ini</Button>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2">
              ...
              <TabsContent value="preview" className="mt-4">
                <div className="overflow-hidden rounded-lg border">
                  <div className="flex h-[600px] flex-col">
                    {/* Header */}
                    <div className="relative h-1/2 w-full bg-teal-900">
                      <div className="absolute inset-0 flex flex-col items-center justify-center p-4 text-center">
                        <div className="mb-4 text-sm uppercase tracking-widest text-teal-300">Undangan Khitanan</div>
                        <h1 className="font-sans text-4xl font-light tracking-wide text-white">RAFI ABDULLAH</h1>
                        <div className="mt-4 text-sm text-teal-300">24 • 01 • 2024</div>
                        <div className="mt-6 flex items-center justify-center">
                          <div className="h-px w-12 bg-teal-500"></div>
                          <div className="mx-4 h-10 w-10 rounded-full border border-teal-500"></div>
                          <div className="h-px w-12 bg-teal-500"></div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex h-1/2 flex-col bg-white p-6 text-center">
                      <h2 className="font-sans text-2xl font-light text-teal-900">Save the Date</h2>
                      ...
                      <div className="mt-6 flex justify-center space-x-8">
                        <div className="flex flex-col items-center">
                          <div className="flex h-16 w-16 items-center justify-center rounded-sm bg-teal-50 text-xl font-light text-teal-900">
                            24
                          </div>
                          <p className="mt-2 text-sm text-teal-700">Hari</p>
                        </div>
                        <div className="flex flex-col items-center">
                          <div className="flex h-16 w-16 items-center justify-center rounded-sm bg-teal-50 text-xl font-light text-teal-900">
                            12
                          </div>
                          <p className="mt-2 text-sm text-teal-700">Jam</p>
                        </div>
                        <div className="flex flex-col items-center">
                          <div className="flex h-16 w-16 items-center justify-center rounded-sm bg-teal-50 text-xl font-light text-teal-900">
                            30
                          </div>
                          <p className="mt-2 text-sm text-teal-700">Menit</p>
                        </div>
                      </div>

                      {/* Preview Note */}
                      <div className="mt-auto border-t border-teal-100 pt-4 text-center">
              ...
              <TabsContent value="demo" className="mt-4">
                <div className="flex h-[600px] flex-col items-center justify-center rounded-lg border p-8 text-center">
                  ...
                  <Link href="/preview/khitanan-03/demo">
                    <Button className="bg-teal-600 hover:bg-teal-700">Buka Demo Interaktif</Button>
                  </Link>
                </div>
              </TabsContent>
            </Tabs>
            ...
            <div className="mt-6 text-center">
              <Link href="/preview/khitanan-03/full-demo">
                <Button className="bg-teal-600 hover:bg-teal-700">Lihat Demo Lengkap</Button>
              </Link>
            </div>
          </div>
        </div>
