  ...
  const timelineEvents = [
    {
      ...
      image: "/assets/aset3/prewed1.jpg",
      position: "left",
    },
    {
      ...
      image: "/assets/aset3/prewed2.jpg",
      position: "right",
    },
    {
      ...
      image: "/assets/aset3/prewed3.jpg",
      position: "left",
    },
    {
      ...
      <header className="sticky top-0 z-50 border-b bg-white/80 backdrop-blur-md">
        <div className="container mx-auto flex h-16 items-center justify-between px-4">
          ...
          <div className="flex items-center space-x-4">
            <Button size="sm" className="bg-black hover:bg-black/80">
              <Link
          ...
          <section id="couple" className="flex flex-col">
            ...
            <div className="flex flex-col items-center p-6 text-center">
              ...
              <p className="text-gray-800">
                ...
                <Button
                variant="outline"
                className="mt-3 flex items-center gap-2 bg-black text-white hover:bg-black/80"
          ...
          <section id="countdown" className="border-t border-gray-200 py-8">
            <div className="flex flex-col items-center justify-center p-4 text-center">
              <div className="relative mb-6 w-full max-w-md">
                <h2 className="font-serif text-2xl font-light tracking-wider text-gray-800">Countdown Timer</h2>
              ...
              <div className="text-center mt-6">
                <p className="mb-2 text-sm font-medium text-gray-700">QS.Ar - Rum 21</p>
          ...
          <section id="gifts" className="border-t border-gray-200 p-6">
            <div className="mb-6 text-center">
              ...
              <p className="text-gray-600">
                ...
                we have provided some options below.
              </p>
            </div>
