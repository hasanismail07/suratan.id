  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold">Template Ulang Tahun 01</h1>
          <p className="mt-2 text-gray-600">Template undangan ulang tahun digital dengan desain ceria dan meriah</p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            <Tabs defaultValue="preview" className="w-full">
              ...
              <TabsContent value="preview" className="mt-4">
                <div className="overflow-hidden rounded-lg border">
                  <div className="flex h-[600px] flex-col">
                    {/* Header */}
                    <div className="relative h-1/2 w-full bg-purple-50">
                      <Image
                        src="/assets/aset6/girl9.jpg"
                        alt="Birthday background"
                        fill
                        className="object-cover opacity-70"
                      />
                      <div className="absolute inset-0 flex flex-col items-center justify-center p-4 text-center">
                        <div className="mb-4 text-sm uppercase tracking-widest text-purple-700">You're Invited!</div>
                        <h1 className="font-sans text-4xl font-bold text-purple-800">
                          Sofia's 7th <br /> Birthday Party
                        </h1>
                        <div className="mt-4 text-sm text-purple-700">Saturday, January 24, 2024</div>
                        <div className="mt-6 flex items-center justify-center">
                          <div className="h-px w-12 bg-purple-300"></div>
                            <div className="mx-4 h-8 w-8 flex items-center justify-center rounded-full bg-purple-100 text-purple-800">
                            🎂
                            </div>
                          <div className="h-px w-12 bg-purple-300"></div>
                        </div>
                    ...
                    {/* Content Preview */}
                    <div className="flex h-1/2 flex-col bg-purple-50/50 p-6 text-center">
                      <h2 className="font-sans text-2xl font-bold text-purple-800">Join the Fun!</h2>
                      <p className="mt-4 text-purple-700">
                        Help us celebrate Sofia's 7th birthday with games, cake, and lots of fun!
                      </p>
                      <div className="mt-6 flex justify-center space-x-8">
                        <div className="flex flex-col items-center">
                          ...
                          <p className="mt-2 text-sm text-purple-700">Days</p>
                        </div>
                        <div className="flex flex-col items-center">
                          <div className="flex h-16 w-16 items-center justify-center rounded-full bg-purple-100 text-xl font-bold text-purple-800">
                            12
                          </div>
                          <p className="mt-2 text-sm text-purple-700">Hours</p>
                        </div>
                        <div className="flex flex-col items-center">
                          <div className="flex h-16 w-16 items-center justify-center rounded-full bg-purple-100 text-xl font-bold text-purple-800">
                            30
                          </div>
                          <p className="mt-2 text-sm text-purple-700">Minutes</p>
                        </div>
                      </div>

                      {/* Preview Note */}
                      <div className="mt-auto border-t border-purple-200 pt-4 text-center">
              ...
              <TabsContent value="demo" className="mt-4">
                <div className="flex h-[600px] flex-col items-center justify-center rounded-lg border p-8 text-center">
                  ...
                  <Link href="/preview/ulang-tahun-01/demo">
                    <Button className="bg-purple-600 hover:bg-purple-700">
                      <Link
                        href="https://wa.me/+6287741704737"
                        target="_blank"
            ...
            <div className="mt-6 text-center">
              <Link href="/preview/ulang-tahun-01/full-demo">
                <Button className="bg-purple-600 hover:bg-purple-700">
                    Lihat Demo Lengkap
                </Button>
              </Link>
